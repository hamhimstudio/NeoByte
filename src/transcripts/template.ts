  ...
  <head>
        ...
        function k(e, t, c, r) {
            ...
            (p +=
              null != b.sL
                ...
                : (function () {
                    ...
                    if (!b.k) return y(m);
                    for (
                      a = "", t = 0, b.lR.lastIndex = 0, r = b.lR.exec(m);
                      r;
          ...
          function a(e, t) {
            ...
            if (i) {
              ...
              return (
                i.starts &&
                  (i.endSameAsBegin && (i.starts.eR = i.eR), u(i.starts)),
                s.rE ? 0 : t.length
              );
            }
          ...
          try {
            ...
            for (a(t.substr(_)), n = b; n.parent; n = n.parent)
              n.cN && (p += N);
    ...
    <script>
      ...
      function showSpoiler(event, element) {
        ...
        if (
          element &&
          element.classList.contains("chatlog__attachment--hidden")
        ) {
          event.preventDefault();
  ...
  <body>
    ...
    <div class="preamble">
      ...
      <div class="preamble__entries-container">
        <div class="preamble__entry" id="guildname">{guild.name}</div>
        <div class="preamble__entry" id="ticketname">{thread.name}</div>
      </div>
    </div>
