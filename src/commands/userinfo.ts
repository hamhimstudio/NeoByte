    ...
    async userinfo(
        ...
        const userInfo = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: "**Spammer**:", value: `${result.flags?.spammer == true}` },
                { name: "**Blacklisted**:", value: `${result.badges.blacklisted == true}` },
                { name: "**Raid Bot**:", value: `${result.badges.raid_bot == true}` },
                { name: "**Scam Bot**:", value: `${result.badges.scam_bot == true}` },
                {
                    name: "Votes:",
